    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <Link href="/gallery/gallery">
            <a className='text-pink-500 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'>Gallery</a>
          </Link>
      </header>
